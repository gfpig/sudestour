...
<head>
    ...
    <title>Pontos Turisticos de Minas Gerais</title>
...
<body style="background-color: #EAE8E8;">
    <nav>
        ...
        <div style="margin-left:8%; width:80%; display:contents">
                ...
                <li class="dropdown"><a class="categorias-menu" href="#" style="background-color: #474747;"><b>Minas Gerais</b></a></li>
    ...
    <div class="container-principal">
        <div class="container-esquerda">
            <div class="container-filtros">
                ...
                <input type='hidden' name='uf' value='MG'/>

                <label for="cidades"><b>Selecione a cidade:</b></label><br>
                <select name="cidades" id="cidades" class="combobox_filtros">
                    <option value=""></option>
                    <?php
                        $result = $mysqli->query("SELECT DISTINCT `Cidade` FROM `local` WHERE Uf = 'MG' ORDER BY `Cidade` ASC");
                ...
                <?php
                    ...
                    $result = $mysqli->query("SELECT DISTINCT categoria.NomeCategoria, categoria.IdCategoria from categoria INNER JOIN local ON categoria.IdCategoria = local.IdCategoria WHERE Uf = 'MG'");
                    while($row = $result->fetch_assoc()) {
            ...
            <div class="direita-destaques">
                <div class="divisaoCategorias">
                    <div id="listaDestaques" class="divisaoItensDestaque">
                        <?php 
                            $result = $mysqli->query("SELECT local.NomeLocal, local.Cep, local.Logradouro, local.Imagem, anunciante.statusPremium FROM `local` INNER JOIN anunciante ON local.CNPJ = anunciante.Cnpj WHERE Uf = 'MG'");
                            while($row = $result->fetch_assoc()) {
