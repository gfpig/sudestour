...
<head>
    ...
    <title>Pontos Turisticos do Espírito Santo</title>
...
<body>
    ...
    <nav>
        ...
        <div style="margin-left:8%; width:80%; display:contents">
            ...
            <li class="dropdown"><a class="categorias-menu" href="#" style="background-color: #474747;"><b>Espírito Santo</b></a></li>
    ...
    <div class="container-principal">
        <div class="container-esquerda">
            <div class="container-filtros">
                ...
                <input type='hidden' name='uf' value='ES'/>
                <label for="cidades"><b>Selecione a cidade:</b></label><br>
                <select name="cidades" id="cidades" class="combobox_filtros">
                    <option value=""></option>
                    <?php
                        $result = $mysqli->query("SELECT DISTINCT `Cidade` FROM `local` WHERE Uf = 'ES' ORDER BY `Cidade` ASC");
